...
if ($error == 0){
 ...
 if (move_uploaded_file($lokasi,'../asset/gambar/'. $namafile)) {

   if (tambah_data($judul, $konten, $namafile, $penulis, $kategori )) {
                   ...
                   <?php } ?>
                    ...
                    <!-- Form Penulis -->
                     ...
                     <div class="input-group">
                       ...
                       <input type="text" class="form-control" placeholder="Masukan Judul" name="penulis" aria-describedby="sizing-addon2">
                   </div>
                 </div>
